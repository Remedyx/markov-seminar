...
\end{cor}
\begin{defn} Let $x,y \in \mathcal{H}$ be two states. We say that $x$ and $y$ communicate if $\mathbb{P}_x(H_y< \infty)>0$ and $\mathbb{P}_y(H_x < \infty)>0$. Alternatively, thanks to the above Proposition we can say, $x$ and $y$ communicate if $G(x,y) >0$ and $G(y,x) >0$. 
\end{defn}
