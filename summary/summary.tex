...
\end{align*}
Let $I = \lbrace A \in \mathcal{F}: T_t^{-1}(A)=A \text{ for all } t \in \mathbb{R} \rbrace$ (necessary?) 
...
\end{defn}
\begin{defn} $\mu$ is called ergodic if $\mu(A) \in \lbrace 0 ,1 \rbrace $ for all $A \in I$. 
\end{defn}
\end{document}
